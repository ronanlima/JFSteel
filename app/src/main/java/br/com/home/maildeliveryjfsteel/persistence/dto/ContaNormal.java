...
public class ContaNormal extends GenericDelivery {
    ...
    public ContentValues getValuesInsert(Context context) {
        ...
        values.put(context.getString(R.string.conta_coletiva), isContaColetiva() ? 1 : 0);
        values.put(context.getString(R.string.conta_protocolada), isContaProtocolada() ? 1 : 0);
        return values;
    }
