...
public class MixedNotaServicoChoiceFragment extends ListFragment {
    ...
    public static MixedNotaServicoChoiceFragment create(String key) {
        Bundle args = new Bundle();
        args.putString(ARG_KEY, key);

        MixedNotaServicoChoiceFragment fragment = new MixedNotaServicoChoiceFragment();
        fragment.setArguments(args);
        return fragment;
    }

    public MixedNotaServicoChoiceFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_mixed_nota_servico_page, container, false);
